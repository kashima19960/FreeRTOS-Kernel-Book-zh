...
## [1 前言](ch01-前言.md#1)
  + [1.1 小型嵌入式系统中的多任务](ch01-前言.md#11)
    + [1.1.1 关于 FreeRTOS 内核](ch01-前言.md#111-freertos)
    + [1.1.2 价值主张](ch01-前言.md#112)
    + [1.1.3 关于术语的说明](ch01-前言.md#113)
    + [1.1.4 为什么要使用 RTOS？](ch01-前言.md#114-rtos)
    + [1.1.5 FreeRTOS 内核特性](ch01-前言.md#115-freertos)
    + [1.1.6 许可协议及 FreeRTOS、OpenRTOS 和 SafeRTOS 家族](ch01-前言.md#116-freertosopenrtossafertos)
  + [1.2 附带的源文件和工程](ch01-前言.md#12)
    + [1.2.1 获取本书配套示例](ch01-前言.md#121)

## [2 FreeRTOS 内核分发包](ch02-FreeRTOS%20内核分发包.md#2-freertos)
  + [2.1 简介](ch02-FreeRTOS%20内核分发包.md#21)
  + [2.2 理解 FreeRTOS 分发包](ch02-FreeRTOS%20内核分发包.md#22-freertos)
    + [2.2.1 定义：FreeRTOS 移植](ch02-FreeRTOS%20内核分发包.md#221-freertos-port)
    + [2.2.2 构建 FreeRTOS](ch02-FreeRTOS%20内核分发包.md#222-freertos)
    + [2.2.3 FreeRTOSConfig.h](ch02-FreeRTOS%20内核分发包.md#223-freertosconfigh)
    + [2.2.4 官方分发包](ch02-FreeRTOS%20内核分发包.md#224)
    + [2.2.5 所有移植通用的 FreeRTOS 源文件](ch02-FreeRTOS%20内核分发包.md#225-port-freertos)
    + [2.2.6 针对特定移植的 FreeRTOS 源文件](ch02-FreeRTOS%20内核分发包.md#226-port-freertos)
    + [2.2.7 头文件包含路径](ch02-FreeRTOS%20内核分发包.md#227)
    + [2.2.8 头文件](ch02-FreeRTOS%20内核分发包.md#228)
  + [2.3 演示应用](ch02-FreeRTOS%20内核分发包.md#23-demo)
  + [2.4 创建 FreeRTOS 工程](ch02-FreeRTOS%20内核分发包.md#24-freertos)
    + [2.4.1 适配提供的演示工程](ch02-FreeRTOS%20内核分发包.md#241-demo)
    + [2.4.2 从零创建新工程](ch02-FreeRTOS%20内核分发包.md#242)
  + [2.5 数据类型和编码风格指南](ch02-FreeRTOS%20内核分发包.md#25)
    + [2.5.1 数据类型](ch02-FreeRTOS%20内核分发包.md#251)
    + [2.5.2 变量命名](ch02-FreeRTOS%20内核分发包.md#252)
    + [2.5.3 函数命名](ch02-FreeRTOS%20内核分发包.md#253)
    + [2.5.4 格式化](ch02-FreeRTOS%20内核分发包.md#254)
    + [2.5.5 宏命名](ch02-FreeRTOS%20内核分发包.md#255)
    + [2.5.6 关于类型强制转换的说明](ch02-FreeRTOS%20内核分发包.md#256)

## [3 堆内存管理](ch03-堆内存管理.md#31)
  + [3.1 简介](ch03-堆内存管理.md#31)
    + [3.1.1 前提条件](ch03-堆内存管理.md#311)
    + [3.1.2 范围](ch03-堆内存管理.md#312)
    + [3.1.3 在静态和动态内存分配之间切换](ch03-堆内存管理.md#313)
    + [3.1.4 使用动态内存分配](ch03-堆内存管理.md#314)
    + [3.1.5 动态内存分配的选项](ch03-堆内存管理.md#315)
  + [3.2 示例内存分配方案](ch03-堆内存管理.md#32)
    ...
    + [3.2.6 初始化 heap\_5：vPortDefineHeapRegions() API 函数](ch03-堆内存管理.md#326-heap_5vportdefineheapregions-api)
  + [3.3 堆相关的实用程序函数和宏](ch03-堆内存管理.md#33)
    + [3.3.1 定义堆起始地址](ch03-堆内存管理.md#331)
    + [3.3.2 xPortGetFreeHeapSize() API 函数](ch03-堆内存管理.md#332-xportgetfreeheapsize-api)
    + [3.3.3 xPortGetMinimumEverFreeHeapSize() API 函数](ch03-堆内存管理.md#333-xportgetminimumeverfreeheapsize-api)
    + [3.3.4 vPortGetHeapStats() API 函数](ch03-堆内存管理.md#334-vportgetheapstats-api)
    + [3.3.5 收集每个任务的堆使用统计信息](ch03-堆内存管理.md#335)
    + [3.3.6 内存分配失败钩子函数](ch03-堆内存管理.md#336-malloc)
    + [3.3.7 将任务堆栈放置在快速内存中](ch03-堆内存管理.md#337)
  + [3.4 使用静态内存分配](ch03-堆内存管理.md#34)
    + [3.4.1 启用静态内存分配](ch03-堆内存管理.md#341)
    + [3.4.2 静态内部内核内存](ch03-堆内存管理.md#342)
...
## [4 任务管理](ch04-任务管理.md#4)
  + [4.1 简介](ch04-任务管理.md#41)
    + [4.1.1 范围](ch04-任务管理.md#411)
  + [4.2 任务函数](ch04-任务管理.md#42)
  + [4.3 顶级任务状态](ch04-任务管理.md#43)
  + [4.4 任务创建](ch04-任务管理.md#44)
    + [4.4.1 xTaskCreate() API 函数](ch04-任务管理.md#441-xtaskcreate-api)
  + [4.5 任务优先级](ch04-任务管理.md#45)
    + [通用调度器](ch04-任务管理.md#451)
    + [架构优化调度器](ch04-任务管理.md#452)
  + [4.6 时间测量和滴答中断](ch04-任务管理.md#46)
  + [4.7 扩展“未运行”状态](ch04-任务管理.md#47)
    + [4.7.1 阻塞状态](ch04-任务管理.md#471-blocked)
    + [4.7.2 挂起状态](ch04-任务管理.md#472-suspended)
    + [4.7.3 就绪状态](ch04-任务管理.md#473-ready)
    + [4.7.4 完成状态转换图](ch04-任务管理.md#474)
    + [4.7.5 vTaskDelayUntil() API 函数](ch04-任务管理.md#475-vtaskdelayuntil-api)
  + [4.8 空闲任务和空闲任务钩子](ch04-任务管理.md#48)
    + [4.8.1 空闲任务钩子函数](ch04-任务管理.md#481)
    + [4.8.2 空闲任务钩子函数的实现限制](ch04-任务管理.md#482)
  + [4.9 改变任务优先级](ch04-任务管理.md#49)
    + [4.9.1 vTaskPrioritySet() API 函数](ch04-任务管理.md#491-vtaskpriorityset-api)
    + [4.9.2 uxTaskPriorityGet() API 函数](ch04-任务管理.md#492-uxtaskpriorityget-api)
  + [4.10 删除任务](ch04-任务管理.md#410)
    + [4.10.1 vTaskDelete() API 函数](ch04-任务管理.md#4101-vtaskdelete-api)
  + [4.11 线程本地存储和可重入性](ch04-任务管理.md#411_1)
    + [4.11.1 C 运行时线程本地存储实现](ch04-任务管理.md#4111-c)
    + [4.11.2 自定义 C 运行时线程本地存储](ch04-任务管理.md#4112-c)
    + [4.11.3 应用程序线程本地存储](ch04-任务管理.md#4113)
  + [4.12 调度算法](ch04-任务管理.md#412)
    + [4.12.1 任务状态和事件回顾](ch04-任务管理.md#4121)
    + [4.12.2 选择调度算法](ch04-任务管理.md#4122)
    + [4.12.3 带时间片的优先级抢占式调度](ch04-任务管理.md#4123)
    + [4.12.4 不带时间片的优先级抢占式调度](ch04-任务管理.md#4124)
    + [4.12.5 协作式调度](ch04-任务管理.md#4125)

## [5 队列管理](ch05-队列管理.md#5)
  + [5.1 简介](ch05-队列管理.md#51)
    + [5.1.1 范围](ch05-队列管理.md#511)
  + [5.2 队列的特性](ch05-队列管理.md#52)
    + [5.2.1 数据存储](ch05-队列管理.md#521)
    + [5.2.2 多任务访问](ch05-队列管理.md#522)
    + [5.2.3 阻塞在队列读取上](ch05-队列管理.md#523)
    + [5.2.4 阻塞在队列写入上](ch05-队列管理.md#524)
    + [5.2.5 阻塞在多个队列上](ch05-队列管理.md#525)
    + [5.2.6 创建队列：静态分配和动态分配队列](ch05-队列管理.md#526)
  + [5.3 使用队列](ch05-队列管理.md#53)
    + [5.3.1 xQueueCreate() API 函数](ch05-队列管理.md#531-xqueuecreate-api)
    + [5.3.2 xQueueSendToBack() 和 xQueueSendToFront() API 函数](ch05-队列管理.md#532-xqueuesendtoback-xqueuesendtofront-api)
    + [5.3.3 xQueueReceive() API 函数](ch05-队列管理.md#533-xqueuereceive-api)
    + [5.3.4 uxQueueMessagesWaiting() API 函数](ch05-队列管理.md#534-uxqueuemessageswaiting-api)
  + [5.4 从多个源接收数据](ch05-队列管理.md#54)
  + [5.5 处理大数据或可变大小数据](ch05-队列管理.md#55)
    + [5.5.1 排队指针](ch05-队列管理.md#551)
    + [5.5.2 使用队列发送不同类型和长度的数据](ch05-队列管理.md#552)
  + [5.6 从多个队列接收](ch05-队列管理.md#56)
    + [5.6.1 队列集](ch05-队列管理.md#561)
    + [5.6.2 xQueueCreateSet() API 函数](ch05-队列管理.md#562-xqueuecreateset-api)
    + [5.6.3 xQueueAddToSet() API 函数](ch05-队列管理.md#563-xqueueaddtoset-api)
    + [5.6.4 xQueueSelectFromSet() API 函数](ch05-队列管理.md#564-xqueueselectfromset-api)
    + [5.6.5 更现实的队列集用例](ch05-队列管理.md#565)
  + [5.7 使用队列创建邮箱](ch05-队列管理.md#57)
    + [5.7.1 xQueueOverwrite() API 函数](ch05-队列管理.md#571-xqueueoverwrite-api)
    + [5.7.2 xQueuePeek() API 函数](ch05-队列管理.md#572-xqueuepeek-api)

## [6 软件定时器管理](ch06-软件定时器管理.md#6)
  + [6.1 章节简介和范围](ch06-软件定时器管理.md#61)
    + [6.1.1 范围](ch06-软件定时器管理.md#611)
  + [6.2 软件定时器回调函数](ch06-软件定时器管理.md#62)
  + [6.3 软件定时器的属性和状态](ch06-软件定时器管理.md#63)
    + [6.3.1 软件定时器的周期](ch06-软件定时器管理.md#631)
    + [6.3.2 单次和自动重载定时器](ch06-软件定时器管理.md#632)
    + [6.3.3 软件定时器状态](ch06-软件定时器管理.md#633)
  + [6.4 软件定时器的上下文](ch06-软件定时器管理.md#64)
    + [6.4.1 RTOS 守护（定时器服务）任务](ch06-软件定时器管理.md#641-rtos)
    + [6.4.2 定时器命令队列](ch06-软件定时器管理.md#642)
    + [6.4.3 守护任务调度](ch06-软件定时器管理.md#643)
  + [6.5 创建和启动软件定时器](ch06-软件定时器管理.md#65)
    + [6.5.1 xTimerCreate() API 函数](ch06-软件定时器管理.md#651-xtimercreate-api)
    + [6.5.2 xTimerStart() API 函数](ch06-软件定时器管理.md#652-xtimerstart-api)
  + [6.6 定时器 ID](ch06-软件定时器管理.md#66-id)
    + [6.6.1 vTimerSetTimerID() API 函数](ch06-软件定时器管理.md#661-vtimersettimerid-api)
    + [6.6.2 pvTimerGetTimerID() API 函数](ch06-软件定时器管理.md#662-pvtimergettimerid-api)
  + [6.7 更改定时器的周期](ch06-软件定时器管理.md#67)
    + [6.7.1 xTimerChangePeriod() API 函数](ch06-软件定时器管理.md#671-xtimerchangeperiod-api)
  + [6.8 重置软件定时器](ch06-软件定时器管理.md#68)
    + [6.8.1 xTimerReset() API 函数](ch06-软件定时器管理.md#681-xtimerreset-api)

## [7 中断管理](ch07-中断管理.md#7)
  + [7.1 简介](ch07-中断管理.md#71)
    + [7.1.1 事件](ch07-中断管理.md#711)
    + [7.1.2 范围](ch07-中断管理.md#712)
  + [7.2 在 ISR 中使用 FreeRTOS API](ch07-中断管理.md#72-isr-freertos-api)
    + [7.2.1 中断安全 API](ch07-中断管理.md#721-api)
    + [7.2.2 使用单独的中断安全 API 的好处](ch07-中断管理.md#722-api)
    + [7.2.3 使用单独的中断安全 API 的缺点](ch07-中断管理.md#723-api)
    + [7.2.4 xHigherPriorityTaskWoken 参数](ch07-中断管理.md#724-xhigherprioritytaskwoken)
    + [7.2.5 portYIELD\_FROM\_ISR() 和 portEND\_SWITCHING\_ISR()宏](ch07-中断管理.md#725-portyield_from_isr-portend_switching_isr)
  + [7.3 延迟中断处理](ch07-中断管理.md#73)
  + [7.4 用于同步的二进制信号量](ch07-中断管理.md#74)
    + [7.4.1 xSemaphoreCreateBinary() API 函数](ch07-中断管理.md#741-xsemaphorecreatebinary-api)
    + [7.4.2 xSemaphoreTake() API 函数](ch07-中断管理.md#742-xsemaphoretake-api)
    + [7.4.3 xSemaphoreGiveFromISR() API 函数](ch07-中断管理.md#743-xsemaphoregivefromisr-api)
    + [7.4.4 改进示例 7.1 中使用的任务的实现](ch07-中断管理.md#744-71)
  + [7.5 计数信号量](ch07-中断管理.md#75)
    + [7.5.1 xSemaphoreCreateCounting() API 函数](ch07-中断管理.md#751-xsemaphorecreatecounting-api)
  + [7.6 将工作推迟到 RTOS 守护任务](ch07-中断管理.md#76-rtos)
    + [7.6.1 xTimerPendFunctionCallFromISR() API 函数](ch07-中断管理.md#761-xtimerpendfunctioncallfromisr-api)
  + [7.7 在中断服务例程中使用队列](ch07-中断管理.md#77)
    + [7.7.1 xQueueSendToFrontFromISR() 和 xQueueSendToBackFromISR() API 函数](ch07-中断管理.md#771-xqueuesendtofrontfromisr-xqueuesendtobackfromisr-api)
    + [7.7.2 从 ISR 使用队列时的注意事项](ch07-中断管理.md#772-isr)
  + [7.8 中断嵌套](ch07-中断管理.md#78)
    + [7.8.1 针对 ARM Cortex-M 和 ARM GIC 用户的说明](ch07-中断管理.md#781-arm-cortex-m-arm-gic)

## [8 资源管理](ch08-资源管理.md#8)
  + [8.1 章节简介和范围](ch08-资源管理.md#81)
    + [8.1.1 互斥](ch08-资源管理.md#811)
    + [8.1.2 范围](ch08-资源管理.md#812)
  + [8.2 关键段和挂起调度程序](ch08-资源管理.md#82)
    + [8.2.1 基本关键段](ch08-资源管理.md#821)
    + [8.2.2 挂起（或锁定）调度程序](ch08-资源管理.md#822)
    + [8.2.3 vTaskSuspendAll() API 函数](ch08-资源管理.md#823-vtasksuspendall-api)
    + [8.2.4 xTaskResumeAll() API 函数](ch08-资源管理.md#824-xtaskresumeall-api)
  + [8.3 互斥量（和二进制信号量）](ch08-资源管理.md#83)
    + [8.3.1 xSemaphoreCreateMutex() API 函数](ch08-资源管理.md#831-xsemaphorecreatemutex-api)
    + [8.3.2 优先级反转](ch08-资源管理.md#832)
    + [8.3.3 优先级继承](ch08-资源管理.md#833)
    + [8.3.4 死锁（或致命拥塞）](ch08-资源管理.md#834)
    + [8.3.5 递归互斥量](ch08-资源管理.md#835)
    + [8.3.6 互斥量和任务调度](ch08-资源管理.md#836)
  + [8.4 守门人任务](ch08-资源管理.md#84-gatekeeper-task)
    + [8.4.1 重写 vPrintString() 以使用守门人任务](ch08-资源管理.md#841-vprintstring)

## [9 事件组](ch09-事件组.md#9)
  + [9.1 章节简介与范围](ch09-事件组.md#91)
    + [9.1.1 范围](ch09-事件组.md#911)
  + [9.2 事件组的特性](ch09-事件组.md#92)
    + [9.2.1 事件组、事件标志和事件位](ch09-事件组.md#921)
    + [9.2.2 有关 EventBits\_t 数据类型的更多信息](ch09-事件组.md#922-eventbits_t)
    + [9.2.3 多任务访问](ch09-事件组.md#923)
    + [9.2.4 使用事件组的实际示例](ch09-事件组.md#924)
  + [9.3 使用事件组进行事件管理](ch09-事件组.md#93)
    + [9.3.1 xEventGroupCreate() API 函数](ch09-事件组.md#931-xeventgroupcreate-api)
    + [9.3.2 xEventGroupSetBits() API 函数](ch09-事件组.md#932-xeventgroupsetbits-api)
    + [9.3.3 xEventGroupSetBitsFromISR() API 函数](ch09-事件组.md#933-xeventgroupsetbitsfromisr-api)
    + [9.3.4 xEventGroupWaitBits() API 函数](ch09-事件组.md#934-xeventgroupwaitbits-api)
    + [9.3.5 xEventGroupGetStaticBuffer() API 函数](ch09-事件组.md#935-xeventgroupgetstaticbuffer-api)
  + [9.4 使用事件组进行任务同步](ch09-事件组.md#94)
    + [9.4.1 xEventGroupSync() API 函数](ch09-事件组.md#941-xeventgroupsync-api)

## [10 任务通知](ch10-任务通知.md#10)
  + [10.1 简介](ch10-任务通知.md#101)
    + [10.1.1 通过中介对象通信](ch10-任务通知.md#1011)
    + [10.1.2 任务通知——直接任务通信](ch10-任务通知.md#1012)
    + [10.1.3 范围](ch10-任务通知.md#1013)
  + [10.2 任务通知的优缺点](ch10-任务通知.md#102)
    + [10.2.1 任务通知的性能优势](ch10-任务通知.md#1021)
    + [10.2.2 RAM 占用优势](ch10-任务通知.md#1022-ram)
    + [10.2.3 任务通知的局限性](ch10-任务通知.md#1023)
  + [10.3 使用任务通知](ch10-任务通知.md#103)
    + [10.3.1 任务通知 API 选项](ch10-任务通知.md#1031-api)
      + [10.3.1.1 完整的 API 函数列表](ch10-任务通知.md#10311-api-27)
    + [10.3.2 xTaskNotifyGive() API 函数](ch10-任务通知.md#1032-xtasknotifygive-api)
    + [10.3.3 vTaskNotifyGiveFromISR() API 函数](ch10-任务通知.md#1033-vtasknotifygivefromisr-api)
    + [10.3.4 ulTaskNotifyTake() API 函数](ch10-任务通知.md#1034-ultasknotifytake-api)
    + [10.3.5 xTaskNotify() 和 xTaskNotifyFromISR() API 函数](ch10-任务通知.md#1035-xtasknotify-xtasknotifyfromisr-api)
    + [10.3.6 xTaskNotifyWait() API 函数](ch10-任务通知.md#1036-xtasknotifywait-api)
    + [10.3.7 任务通知在外设驱动中的应用：UART 示例](ch10-任务通知.md#1037-uart)
    + [10.3.8 任务通知在外设驱动中的应用：ADC 示例](ch10-任务通知.md#1038-adc)
    + [10.3.9 任务通知在应用程序中的直接使用](ch10-任务通知.md#1039)

## [11 低功耗支持](ch11-低功耗支持.md#11)
  + [11.1 节能简介](ch11-低功耗支持.md#111)
  + [11.2 FreeRTOS 睡眠模式](ch11-低功耗支持.md#112-freertos)
  + [11.3 启用内置无滴答空闲功能的方法](ch11-低功耗支持.md#113-tickless-idle)
    + [11.3.1 portSUPPRESS\_TICKS\_AND\_SLEEP() 宏](ch11-低功耗支持.md#1131-portsuppress_ticks_and_sleep)
    + [11.3.2 vPortSuppressTicksAndSleep 函数](ch11-低功耗支持.md#1132-vportsuppressticksandsleep)
    + [11.3.3 eTaskConfirmSleepModeStatus 函数](ch11-低功耗支持.md#1133-etaskconfirmsleepmodestatus)
    + [11.3.4 configPRE\_SLEEP\_PROCESSING 配置](ch11-低功耗支持.md#1134-configpre_sleep_processing)
    + [11.3.5 configPOST\_SLEEP\_PROCESSING 配置](ch11-低功耗支持.md#1135-configpost_sleep_processing)
  + [11.4 Implementing portSUPPRESS\_TICKS\_AND\_SLEEP() Macro](ch11-低功耗支持.md#114-portsuppress_ticks_and_sleep)
  + [11.5 Idle Task Hook Function](ch11-低功耗支持.md#115)

## [12 开发者支持](ch12-开发者支持.md#12)
  + [12.1 简介](ch12-开发者支持.md#121)
  + [12.2 configASSERT()](ch12-开发者支持.md#122-configassert)
    + [12.2.1 示例 configASSERT() 定义](ch12-开发者支持.md#1221-configassert)
  + [12.3 Tracealyzer for FreeRTOS](ch12-开发者支持.md#123-freertos-tracealyzer)
  + [12.4 调试相关的钩子（回调）函数](ch12-开发者支持.md#124-hook)
    + [12.4.1 内存分配失败钩子](ch12-开发者支持.md#1241-malloc)
    + [12.4.2 堆栈溢出钩子](ch12-开发者支持.md#1242)
  + [12.5 查看运行时和任务状态信息](ch12-开发者支持.md#125)
    + [12.5.1 任务运行时统计信息](ch12-开发者支持.md#1251)
    + [12.5.2 运行时统计时钟](ch12-开发者支持.md#1252)
    + [12.5.3 配置应用程序以收集运行时统计信息](ch12-开发者支持.md#1253)
    + [12.5.4 uxTaskGetSystemState() API 函数](ch12-开发者支持.md#1254-uxtaskgetsystemstate-api)
    + [12.5.5 vTaskListTasks() 帮助函数](ch12-开发者支持.md#1255-vtasklisttasks)
    + [12.5.6 vTaskGetRunTimeStatistics() 帮助函数](ch12-开发者支持.md#1256-vtaskgetruntimestatistics)
    + [12.5.7 生成和显示运行时统计信息的示例](ch12-开发者支持.md#1257)
  + [12.6 跟踪钩子宏](ch12-开发者支持.md#126-hook-trace-hook-macros)
    + [12.6.1 可用的跟踪钩子宏](ch12-开发者支持.md#1261-trace-hook)
    + [12.6.2 定义跟踪钩子宏](ch12-开发者支持.md#1262-trace-hook)
    + [12.6.3 FreeRTOS 感知调试器插件](ch12-开发者支持.md#1263-freertos)

## [13 故障排查](ch13-故障排查.md#13)
  + [13.1 章节简介与范围](ch13-故障排查.md#131)
  + [13.2 中断优先级](ch13-故障排查.md#132)
  + [13.3 堆栈溢出](ch13-故障排查.md#133)
    + [13.3.1 The uxTaskGetStackHighWaterMark() API Function](ch13-故障排查.md#1331-uxtaskgetstackhighwatermark-api)
    + [13.3.2 运行时堆栈检查 - 概述](ch13-故障排查.md#1332)
    + [13.3.3 运行时堆栈检查 - 方法 1](ch13-故障排查.md#1333-1)
    + [13.3.4 运行时堆栈检查 - 方法 2](ch13-故障排查.md#1334-2)
    + [13.3.4 运行时堆栈检查 - 方法 3](ch13-故障排查.md#1334-3)
  + [13.4 对 printf() 和 sprintf() 的使用](ch13-故障排查.md#134-printf-sprintf)
    + [13.4.1 Printf-stdarg.c](ch13-故障排查.md#1341-printf-stdargc)
  + [13.5 其他常见错误来源](ch13-故障排查.md#135)
    + [13.5.1 症状：向演示添加简单任务导致演示崩溃](ch13-故障排查.md#1351)
    + [13.5.2 症状：在中断中使用 API 函数导致应用崩溃](ch13-故障排查.md#1352-api)
    + [13.5.3 症状：有时应用在中断服务例程中崩溃](ch13-故障排查.md#1353)
    + [13.5.4 症状：调度器尝试启动第一个任务时崩溃](ch13-故障排查.md#1354)
    + [13.5.5 症状：中断意外地保持禁用，或临界区未正确嵌套](ch13-故障排查.md#1355)
    + [13.5.6 症状：应用程序在调度程序启动之前崩溃](ch13-故障排查.md#1356)
    + [13.5.7 症状：在调度程序挂起或临界区内调用 API 函数导致应用崩溃](ch13-故障排查.md#1357-api)
  + [13.6 其他调试步骤](ch13-故障排查.md#136)
